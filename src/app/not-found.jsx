...
function ErrorPage() {
  return (
    <div className="error-page pt-16 mx-4">
      <Container>
        <div className="error-page-content flex flex-col justify-center md:flex-row md:items-center md:justify-between text-[#2f3237]">
          <div className="error-page-info md:w-[calc(50%-20px)] md:mr-16">
            <div className="error-page-title text-3xl mb-8">
              <div className="text-[100px] leading-[100%] md:text-[150px]">
                404
              </div>
              Page Not Found
            </div>
