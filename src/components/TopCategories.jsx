        ...
        >
          {categories?.map((category) => (
            ...
            >
              ...
              />
              <div className="overlay-onHover opacity-0 hover:opacity-100 hover:bg-[rgba(34,34,34,0.4)] absolute top-0 left-0 w-full h-full flex flex-col gap-3 text-center justify-center items-center transition-opacity duration-200 ease-in">
                <h5
                  className={clsx(
